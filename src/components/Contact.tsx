    ...
    <>
      <div className="lg:grid grid-cols-2 items-center gap-4">
        ...
        <div className="px-3 mt-5">
          <h2 className=" pl-20 text-3xl text-center font-semibold">Datos De Contacto</h2>

          <div className="h-[20rem] flex flex-col justify-around items-start font-bold bg-amber-200/60 rounded-2xl p-5 my-5">
